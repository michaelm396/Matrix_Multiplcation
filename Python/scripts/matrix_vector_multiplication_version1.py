...
def main():
    ...
    #w = pd.ExcelWriter('matrix_vector_multiplication_version1.xlsx', engine='xlsxwriter')
    with pd.ExcelWriter('matrix_vector_multiplication_version1.xlsx', engine='xlsxwriter') as w:
